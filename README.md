...
This project is to implement a machine learning pipeline to classify network traffic anomalies.
Using RFC, XGBOOST, PYTORCH to compare which model will better help detecting future attacks against malicious
methods to a companies network. 
...
Monday files - Monday files show explanation to all models codes and what they do.


## Objectives

1. Anomaly Detection: Normal vs Flagged risked traffic.
